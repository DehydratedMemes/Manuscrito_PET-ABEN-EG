...
\title{Computational study of the glycolitic degradation of \iupac{poly|(ethylene terephthalate)} catalyzed by \iupac{\N^1,\N^2-bis|(2-amino|benzyl)|-1,2-|diamino|ethane zinc(II)}}
